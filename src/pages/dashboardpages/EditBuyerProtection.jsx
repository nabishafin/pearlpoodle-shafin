...
const EditBuyerProtection = () => {
  ...
  const handleSaveChanges = () => {
    console.log("Saving Buyer Protection content:", content);
    alert("Buyer Protection content saved successfully!");
  };
  ...
  return (
    <div className="bg-gray-100">
      ...
      <div className="bg-[#017783] text-white p-4 flex items-center gap-3">
        ...
        <h1 className="text-lg font-medium">Edit Buyer Protection</h1>
      </div>
...
export default EditBuyerProtection;
